                                    ...
                                    <Col> 
                                            ...
                                            <ListGroupItem color='success'>New</ListGroupItem>
                                                ...
                                                if (dynamicData.Status === "New") {
                                                 ...
                                                 <ListGroupItem tag="button" onClick={this.toggleButton}  value={dynamicData.Title} id={dynamicData.Status} name={dynamicData.EstimatedBudget} action>{dynamicData.Title}</ListGroupItem>
                                                 <AddDepModal show={this.state.toggle} onHide={depModalClose} value1={this.state.value} id1={this.state.id} name1={this.state.name} />
                                                    </div>
                                                    )
                                                }})
                                            }
